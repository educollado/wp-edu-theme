...
- **Diseño propio** — paleta cálida (crema + rojo), tipografía editorial con Fraunces, Figtree e IBM Plex Mono
...
| `--color-accent-primary` | `#b42318` | Rojo oscuro — acento principal |
| `--color-accent-secondary` | `#dc2626` | Rojo vivo |
| `--color-text-primary` | `#2b211f` | Texto principal |
| `--color-text-secondary` | `#5f504b` | Texto secundario |
...
| `title` | — | Título de la sección |
| `img_position` | `right` | Posición de la imagen: `left`, `right`, `up` o `down` |
...
Muestra el último artículo de una categoría con imagen a izquierda, derecha, arriba o abajo. Sin reproductor de audio.
